...
class MMIM_top(nn.Module):
    ...
    def forward(self, text, visual, acoustic, y=None, mem=None):
        """
        ...
        #fusion, preds = self.fusion_prj(torch.cat([text, visual], dim=1))
