...
def eval_mosei_senti(results, truths, exclude_zero, train_loss, val_loss):
    ...
    print("-" * 50)
    return {'mae':mae, 'corr':corr, 'mult':mult_a7, 'f1':f_score, 'acc2':acc_2, 'train_loss':train_loss, 'val_loss':val_loss}

def eval_mosi(results, truths, exclude_zero, train_loss, val_loss):
    return eval_mosei_senti(results, truths, exclude_zero, train_loss, val_loss)
