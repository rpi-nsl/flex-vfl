...
def get_args():
    ...
    parser.add_argument('--alg', type=str, default='flex',
                        help='use Flex-VFL, Sync-VFL, P-BCD, or VAFL algorithm.')
...
def get_config(dataset='mosi', mode='train', batch_size=32, labeled_frac=1.0):
